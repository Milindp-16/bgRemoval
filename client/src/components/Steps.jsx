        ...
        <div className='flex items-start flex-wrap gap-4 mt-16 xl:mt-24 justify-center '>
            ...
            <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
                ...
                <div>
                    ...
                    <p className='text-sm text-neutral-500 mt-1 '>Upload the image whose background is <br /> to be removed.</p>
                </div>
            </div>
            ...
            <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
                ...
                <div>
                    ...
                    <p className='text-sm text-neutral-500 mt-1 '>Remove the background of the your <br /> image by just one click.</p>
                </div>
            </div>
            ...
            <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
                ...
                <div>
                    ...
                    <p className='text-sm text-neutral-500 mt-1 '>Download high quality image with its <br /> background removed.</p>
                </div>
            </div>
