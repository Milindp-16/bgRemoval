  ...
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
        ...
        <div>
            ...
            <p className='my-6 text-[15px] text-gray-500  '>Say goodbye to cluttered photos, our background removal SaaS delivers studio-quality <br className='max-sm:hidden'/> cutouts instantly.
                Scale your workflow with bulk uploads and transparent PNGs.</p>
            <div>
